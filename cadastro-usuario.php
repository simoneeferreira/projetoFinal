        ...
        <div id="page">
            ...
            <main id="dashboard">
                <nav id="menu-dashboard">
                    ...
                    <h2>Usuários</h2>
                    <a href="cadastro-usuario.php"><button type="button" class="btn btn-secondary active">Cadastro</button></a><br>
                ...
                <div id="content-dashboard">
                    <div>
                        ...
                        <form action="grava-usuario.php" method="post" name="frm-cadastra">
                            <label>Login</label>
